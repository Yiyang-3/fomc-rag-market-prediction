#!/usr/bin/env python3
"""Online RAG retrieval + prediction pipeline for the frontend."""
...
def build_dynamic_shock_vector(
    ...
    if not base_row.empty:
        ...
        # We cannot recover exact original statement text from shocks; only use stored shocks when text is unchanged later.
        del same_current  # keep branch explicit
...
def build_frontend_payload(
    ...
    return {
        ...
        "materials": {
            ...
            "research_report_pdf": str(frontend_data.REPORT_PDF_FILE.relative_to(PROJECT_ROOT)),
