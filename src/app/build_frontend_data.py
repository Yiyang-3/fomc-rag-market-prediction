#!/usr/bin/env python3
"""Build static frontend data for the FOMC user-report dashboard."""
...
FRONTEND_DIR = PROJECT_ROOT / "frontend" / "fomc_report_app"
...
REPORT_FILE = PROJECT_ROOT / "docs" / "experiment_report_2.md"
REPORT_PDF_FILE = PROJECT_ROOT / "docs" / "experiment_report_latest_ablation.pdf"
...
def main() -> int:
    ...
    params = pd.read_csv(TUNED_PARAMS_FILE)
    ...
    data = {
        ...
        "materials": {
            ...
            "research_report_pdf": str(REPORT_PDF_FILE.relative_to(PROJECT_ROOT)),
